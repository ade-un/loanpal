"""
Django settings for loanpal project.
...
ALLOWED_HOSTS = ['loanpal.vercel.app', 'loanpal-git-master-ade-uns-projects.vercel.app','127.0.0.1','localhost']
...
WSGI_APPLICATION = 'loanpal.wsgi.application'
